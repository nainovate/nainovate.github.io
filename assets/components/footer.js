            ...
            <footer class="bg-black dark:bg-white text-white dark:text-black py-12 md:py-16">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div class="md:col-span-2">
                            ...
                            <div class="flex space-x-4">
                                <a href="https://www.linkedin.com/company/nainovate-technologies/" class="text-gray-400 hover:text-white transition-colors">
                        ...
                        <div>
                            ...
                            <ul class="space-y-2 text-gray-400">
                                <li><a href="digital-transformation.html" class="hover:text-white transition-colors">Digital Transformation</a></li>
                                <li><a href="ai-transformation.html" class="hover:text-white transition-colors">AI Transformation</a></li>
                                <li><a href="case-studies.html" class="hover:text-white transition-colors">Case Studies</a></li>
                                <li><a href="clients.html" class="hover:text-white transition-colors">Clients</a></li>
                            </ul>
                        </div>
                        <div>
                    ...
                    <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                        <p>&copy; ${new Date().getFullYear()} Nainovate. All rights reserved.</p>
                    </div>
                </div>
            </footer>
        `;
